...
COPY public.equipos (id, nombre, descripcion, lider) FROM stdin;
1	Equipo05	\N	\N
2	sala03	Este es nivel de prueba	\N
3	sala01	este nivel modificado	3
\.
...
COPY public.usuarios (id, acceso, administrador, email, fecha_nacimiento, nombre, password) FROM stdin;
1	t	f	adel@ua	2000-04-17	adel	123
2	t	f	admin@ua	2001-01-17	admin	123
3	t	t	administrador@ua	2000-04-17	admin	123
\.
